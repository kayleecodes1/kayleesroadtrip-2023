...
import {
  ...
  v4_default,
  visitDiff
} from "./chunk-Q3NEA5Q2.js";
import {
  require_jsx_runtime
} from "./chunk-AJSIGQ7F.js";
import {
  __toESM,
  require_react
} from "./chunk-RKTMYPMC.js";

// ../../node_modules/sanity/lib/_chunks/index-6c71f0c1.js
...
function IntentResolver(_ref10) {
  ...
  const [nextRouterPanes, setNextRouterPanes] = (0, import_react.useState)(null);
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./index-bed68c8a-Z5W34XZU.js")),
  document: (0, import_react.lazy)(() => import("./index-9357fb28-35VQVM6C.js")),
  documentList: (0, import_react.lazy)(() => import("./index-706f5feb-2UXSFN7N.js")),
  list: (0, import_react.lazy)(() => import("./index-d0724341-Z7E5CPGG.js"))
};
...
var DocumentPaneProvider = (0, import_react.memo)((props) => {
  ...
  const timeline = (0, import_react.useMemo)(() => historyStore.getTimeline({
  ...
  const displayed = (0, import_react.useMemo)(
  ...
  const liveEdit = (0, import_react.useMemo)(() => Boolean(schemaType == null ? void 0 : schemaType.liveEdit), [documentType, schema]);
  ...
  const handleOpenPath = (0, import_react.useCallback)((path) => {
...
var Timeline = (_ref21) => {
  ...
  const [loadingElement, setLoadingElement] = (0, import_react.useState)(null);
  let state = disabledBeforeSelection ? "disabled" : "enabled";
  const checkIfLoadIsNeeded = (0, import_react.useCallback)(() => {
  ...
  (0, import_react.useEffect)(checkIfLoadIsNeeded, [checkIfLoadIsNeeded]);
...
function TimelineMenu(_ref22) {
  ...
  const [menuContent, setMenuContent] = (0, import_react.useState)(null);
  ...
  const loadMoreHistory = (0, import_react.useCallback)((state) => {
...
var DocumentPanelHeader = (0, import_react.memo)((0, import_react.forwardRef)((_ref28, ref) => {
  let {
    rootElement
  } = _ref28;
  const {
...
var DeskTool = (0, import_react.memo)(function DeskTool2(_ref35) {
  let {
    onPaneChange
  } = _ref35;
  var _a;
...
function DeskToolBoundary(_ref37) {
  ...
  const intent = (0, import_react.useMemo)(() => {
...
//# sourceMappingURL=chunk-6TRLK2PF.js.map
