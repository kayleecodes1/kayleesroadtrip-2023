import {
  PaneItem
} from "./chunk-DCG5C5PL.js";
import {
  Delay,
  useDeskTool,
  useDeskToolSetting
} from "./chunk-6TRLK2PF.js";
import "./chunk-QBDRMA2J.js";
import {
  BackLink,
  Pane,
  PaneContent,
...
// ../../node_modules/sanity/lib/_chunks/index-706f5feb.js
...
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    ...
    if ((_c = item == null ? void 0 : item.params) == null ? void 0 : _c.extendedProjection) {
      return {
        ...item,
        selected: (sortOrder == null ? void 0 : sortOrder.extendedProjection) === ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.extendedProjection)
      };
    }
    if ((_e = item == null ? void 0 : item.params) == null ? void 0 : _e.by) {
      return {
        ...item,
        selected: (0, import_isEqual.default)(sortOrder == null ? void 0 : sortOrder.by, ((_f = item == null ? void 0 : item.params) == null ? void 0 : _f.by) || EMPTY_ARRAY)
      };
    }
    return {
      ...item,
...
//# sourceMappingURL=index-706f5feb-2UXSFN7N.js.map
